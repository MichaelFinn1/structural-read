...
for folder in BASE.glob("measured_*_window_dial_dense_v1"):
    terrain = folder.name.replace("measured_", "").replace("_window_dial_dense_v1", "")
    src = folder / "traversal_windows_v0.csv"
    out = VIZ / f"local_ecology_window_dial_{terrain}_dense_v1.html"
...
<head>
<meta charset="utf-8">
<title>{terrain} Local Ecology Window Dial Dense V1</title>
<style>
...
<body>
<div id="wrap">
<h1>{terrain} Local Ecology Window Dial Dense V1</h1>
<div id="label"></div>
...
<div class="note">Calibration read: observe replay-visible morphology without semantic claims.</div>
</div>
<script>
