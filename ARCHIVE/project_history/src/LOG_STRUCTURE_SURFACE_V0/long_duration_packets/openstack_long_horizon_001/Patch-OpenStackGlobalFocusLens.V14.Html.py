...
src = base / "openstack_global_focus_lens_v13.html"
out = base / "openstack_global_focus_lens_v14.html"

text = src.read_text(encoding="utf-8")
text = text.replace("OpenStack Global Focus Lens V13", "OpenStack Global Focus Lens V14")
