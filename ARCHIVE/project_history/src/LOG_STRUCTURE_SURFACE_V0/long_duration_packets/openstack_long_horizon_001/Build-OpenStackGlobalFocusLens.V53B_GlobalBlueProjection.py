...
OUT = BASE / "visualizations" / "openstack_global_focus_lens_v53b_global_blue_projection.html"
...
<head>
<meta charset="utf-8">
<title>OpenStack Global Focus Lens V53B Global Blue Projection</title>
<style>
.rawLogRow {{
  display: block;
  opacity: 1;
...
<body>
<div id="wrap">
<h1>OpenStack Global Focus Lens V53B Global Blue Projection</h1>
...
function render() {{
  ...
  ensureLensProfiles();
  updateLensProfiles();
  setTimeout(renderProjectionLines, 0);
}}
