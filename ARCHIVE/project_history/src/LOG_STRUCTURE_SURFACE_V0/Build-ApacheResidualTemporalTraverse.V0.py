...
SOURCE = Path(
    r"C:\Users\Admin\Desktop\StructuralRead_FirstUserTest\terrain\loghub_2k_panel\Apache\Apache_2k.log"
)

OUTDIR = Path("Apache_residual_temporal_001_out")
...
out = OUTDIR / "Apache_residual_temporal_windows_v0.csv"
