...
SRC = BASE / "measured_linux_window_dial_dense_v1" / "traversal_windows_v0.csv"
OUT = BASE / "movement_visualizations" / "local_ecology_window_dial_linux_dense_v1.html"
...
<head>
<meta charset="utf-8">
<title>Linux Local Ecology Window Dial Dense V1</title>
<style>
...
<body>
<div id="wrap">
<h1>Linux Local Ecology Window Dial Dense V1</h1>
<div id="label"></div>
...
<div class="note">Read question: does Linux spacing-basin behavior remain broad, local, or dissolve under dense constitution traversal?</div>
</div>
