...
SOURCE = Path(
    r"C:\Users\Admin\Desktop\StructuralRead_FirstUserTest\terrain\loghub_2k_panel\BGL\BGL_2k.log"
)

OUTDIR = Path("BGL_residual_temporal_001_out")
...
out = OUTDIR / "BGL_residual_temporal_windows_v0.csv"
