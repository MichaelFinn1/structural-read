...
SOURCE = Path(
    r"C:\Users\Admin\Desktop\StructuralRead_FirstUserTest\terrain\loghub_2k_panel\HDFS\HDFS_2k.log"
)

OUTDIR = Path("HDFS_residual_temporal_001_out")
...
out = OUTDIR / "HDFS_residual_temporal_windows_v0.csv"
