...
OUT = BASE / "visualizations" / "openstack_global_focus_lens_v49a.html"
...
<head>
<meta charset="utf-8">
<title>OpenStack Global Focus Lens V49A</title>
<style>
...
<body>
<div id="wrap">
<h1>OpenStack Global Focus Lens V49A</h1>
...
saveBookmark.addEventListener("click", evt => {{
  ...
  bookmarkPreview.textContent =
    ...
    card.innerHTML =
      ...
      "lines: " + bookmark.focus_start + "-" + bookmark.focus_end + "<br>" +
