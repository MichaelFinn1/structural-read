...
OUT = BASE / "visualizations" / "openstack_global_focus_lens_v53d_frame_containment_clean.html"
...
<head>
<meta charset="utf-8">
<title>OpenStack Global Focus Lens V53D Frame Containment Clean</title>
<style>
.rawLogRow {{
  display: block;
  opacity: 1;
...
<body>
<div id="wrap">
<h1>OpenStack Global Focus Lens V53D Frame Containment Clean</h1>
...
function renderFocusBottomLabelsAndCounts() {{
  ...
  if (inspectionStart !== null && inspectionEnd !== null) {{
    ...
    addFrameBottomLabel(band, "blue", pctForFocusLine(center, s), center);
  }}
...
function renderProjectionLines() {{
  ...
  if (aperture && micro) {{
    ...
    addProjectionLine(svg, a.left, a.bottom, m.left, m.top, "#2f6f9f");
    addProjectionLine(svg, a.right, a.bottom, m.right, m.top, "#2f6f9f");
  }}
}}
