...
OUT = BASE / "visualizations" / "openstack_global_focus_lens_v52i_ui_refine_safe.html"
...
<head>
<meta charset="utf-8">
<title>OpenStack Global Focus Lens V52I UI Refine Safe</title>
<style>
.rawLogRow {{
  display: block;
  opacity: 1;
...
<body>
<div id="wrap">
<h1>OpenStack Global Focus Lens V52I UI Refine Safe</h1>
...
<div id="csvSelectionControls" style="margin:10px 0 12px 0; padding:8px; border:1px solid #bbb; background:#fafafa;">
  <div style="margin-bottom:6px;">
    <button id="selectAllFocus" style="font-size:14px;">Select all focus</button>
    <button id="deselectAllFocus" style="font-size:14px;">Deselect all focus</button>
    <button id="selectWhiteFocus" style="font-size:14px;">Select white</button>
    <button id="selectGreyFocus" style="font-size:14px;">Select grey</button>
    <button id="selectBlackFocus" style="font-size:14px;">Select black</button>
  </div>
  <div>
...
function applySelectionRuleToFocus(rule) {{
  ...
  csvStatus.textContent = "Applied additive selection: " + rule;
