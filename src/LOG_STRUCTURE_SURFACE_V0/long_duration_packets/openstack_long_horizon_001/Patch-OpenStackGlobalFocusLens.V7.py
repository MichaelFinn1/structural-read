...
path = Path("src/LOG_STRUCTURE_SURFACE_V0/long_duration_packets/openstack_long_horizon_001/Build-OpenStackGlobalFocusLens.V7.py")
text = path.read_text(encoding="utf-8")

text = text.replace("OpenStack Global Focus Lens V6", "OpenStack Global Focus Lens V7")
text = text.replace("openstack_global_focus_lens_v6.html", "openstack_global_focus_lens_v7.html")
...
'''
text = old_box.sub(new_box, text, count=1)
