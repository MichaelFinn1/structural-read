...
VIZ = BASE / "visualizations_v3"
VIZ.mkdir(parents=True, exist_ok=True)

for folder in BASE.glob("measured_*_window_dial_dense_v3"):
    terrain = folder.name.replace("measured_", "").replace("_window_dial_dense_v3", "")
    src = folder / "traversal_windows_v0.csv"
    out = VIZ / f"local_ecology_window_dial_{terrain}_dense_v3.html"
...
<body>
<div id="wrap">
<h1>{terrain} Local Ecology Window Dial Dense V3</h1>
<div id="label"></div>
...
<div class="note">Calibration V3: emitted recurrence ecology is intentionally varied.</div>
</div>
<script>
